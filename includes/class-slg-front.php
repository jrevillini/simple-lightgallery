						...
						foreach ( self::$selected_plugins as $selected_plugin => $value ) {
							...
							switch ( $selected_plugin ):
								case 'autoplay':
									...
									break;
								case 'comment':
									wp_register_script( 'lightgallery-lg-comment-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/comment/lg-comment.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-comment-min' );
									break;
								case 'fullscreen':
									wp_register_script( 'lightgallery-lg-fullscreen-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/fullscreen/lg-fullscreen.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-fullscreen-min' );
									break;
								case 'hash':
									wp_register_script( 'lightgallery-lg-hash-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/hash/lg-hash.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-hash-min' );
									break;
								case 'mediumZoom':
									wp_register_script( 'lightgallery-lg-mediumZoom-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/mediumZoom/lg-medium-zoom.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-mediumZoom-min' );
									break;
								case 'pager':
									wp_register_script( 'lightgallery-lg-pager-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/pager/lg-pager.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-pager-min' );
									break;
								case 'relativeCaption':
									wp_register_script( 'lightgallery-lg-relativeCaption-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/relativeCaption/lg-relative-caption.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-relativeCaption-min' );
									break;
								case 'rotate':
									wp_register_script( 'lightgallery-lg-rotate-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/rotate/lg-rotate.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-rotate-min' );
									break;
								case 'share':
									wp_register_script( 'lightgallery-lg-share-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/share/lg-share.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-share-min' );
									break;
								case 'thumbnail':
									wp_register_script( 'lightgallery-lg-thumbnail-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/thumbnail/lg-thumbnail.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-thumbnail-min' );
									break;
								case 'video':
									wp_register_script( 'lightgallery-lg-video-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/video/lg-video.min.js', array('lightgallery-min'), '2.7.0', false );
									wp_enqueue_script( 'lightgallery-lg-video-min' );
									break;
								case 'zoom':
									wp_register_script( 'lightgallery-lg-zoom-min', plugin_dir_url( __DIR__ ) . 'assets/lightgallery/v2/plugins/zoom/lg-zoom.min.js', array('lightgallery-min'), '2.7.0', false );
